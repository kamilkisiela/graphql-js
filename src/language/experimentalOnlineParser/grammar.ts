...
export type GraphQLGrammarConstraintsSet = ReadonlyArray<
...
export interface GraphQLGrammarBaseRuleConstraint {
  butNot?:
    | GraphQLGrammarTokenConstraint
    | ReadonlyArray<GraphQLGrammarTokenConstraint>;
  optional?: boolean;
...
export interface GraphQLGrammarPeekConstraint
  extends GraphQLGrammarBaseRuleConstraint {
  peek: ReadonlyArray<GraphQLGrammarPeekConstraintCondition>;
}
export interface GraphQLGrammarPeekConstraintCondition {
  ifCondition: GraphQLGrammarTokenConstraint | string;
