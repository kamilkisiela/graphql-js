...
import isFunction from '../jsutils/isFunction';
...
interface GraphQLScalarTypeNormalizedConfig
  extends GraphQLScalarTypeConfig<any, any> {
  serialize: GraphQLScalarSerializer<any>;
  parseValue: GraphQLScalarValueParser<any>;
  parseLiteral: GraphQLScalarLiteralParser<any>;
  extensions: Maybe<ReadOnlyObjMap<any>>;
...
export interface GraphQLEnumTypeConfig /* <T> */ {
  name: string;
  description?: Maybe<string>;
...
export interface GraphQLEnumValueConfig /* <T> */ {
  description?: Maybe<string>;
  value?: any /* T */;
  deprecationReason?: Maybe<string>;
  extensions?: Maybe<ReadOnlyObjMapLike<any>>;
...
export interface GraphQLEnumValue /* <T> */ {
  name: string;
  description: Maybe<string>;
  value: any /* T */;
  deprecationReason: Maybe<string>;
